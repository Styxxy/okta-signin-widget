...
This document is provided as a reference for customers who are still using Classic Engine or who are in the process of migrating to OIE. To begin using the [interaction code][] flow in the Okta Sign-In Widget follow this [migration guide](https://developer.okta.com/docs/guides/migrate-to-oie/).
